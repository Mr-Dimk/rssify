...
- [ ] 1.1.3. Создать структуру папок (app/, tests/, config/, logs/)
- [ ] 1.1.4. Создать подпапки в app/ (routers/, templates/, static/)
- [ ] 1.1.5. Инициализировать git и сделать первый коммит

### 1.2 Настройка окружения
- [ ] 1.2.1. Создать файл requirements.txt с зависимостями
- [ ] 1.2.2. Создать файл .env для конфигурации
- [ ] 1.2.3. Создать файл .gitignore
- [ ] 1.2.4. Создать виртуальное окружение Python
- [ ] 1.2.5. Установить зависимости из requirements.txt

### 1.3 Базовые файлы
- [ ] 1.3.1. Создать app/__init__.py
- [ ] 1.3.2. Создать app/main.py (пустой FastAPI app)
- [ ] 1.3.3. Проверить запуск uvicorn app.main:app --reload
...
- [ ] 2.1.1. Создать app/database.py
- [ ] 2.1.2. Настроить подключение к SQLite
- [ ] 2.1.3. Создать функцию get_db() для dependency injection
- [ ] 2.1.4. Настроить Base для SQLAlchemy моделей
